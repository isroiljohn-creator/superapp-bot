            ...
            <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
              ...
              <SheetContent side="left" className="w-64 p-0">
                <div className="p-4 border-b border-border">
                  <h1 className="text-2xl font-bold tracking-tight text-foreground/90">YASHA Admin <span className="text-xs font-mono text-muted-foreground ml-2 opacity-50">v2.4 (Real Sync)</span></h1>
