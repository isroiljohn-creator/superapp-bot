...
export const FriendsScreen: React.FC<FriendsScreenProps> = ({ onBack }) => {
  ...
  const friends: Friend[] = [
    { id: '1', name: 'Aziz', level: 5, xp: 1200, status: 'online' },
    { id: '2', name: 'Malika', level: 8, xp: 2500, status: 'online' },
    { id: '3', name: 'Jasur', level: 3, xp: 800, status: 'offline' },
    { id: '4', name: 'Dilnoza', level: 12, xp: 4200, status: 'offline' },
  ];

  const leaderboard: LeaderboardEntry[] = [
    { rank: 1, name: 'Dilnoza', score: 4200 },
    { rank: 2, name: 'Malika', score: 2500 },
    { rank: 3, name: 'Aziz', score: 1200 },
    { rank: 4, name: 'Jasur', score: 800 },
    { rank: 5, nameKey: 'friends.you', name: '', score: 500 },
  ];
